...
\begin{titlepage}
    ...
    % More authors can be inserted here with additional figures or subfigures.
...
\begin{lstlisting}[language=TeX]
\includegraphics[scale = 0.3, angle = 60, clip = true]{assets/example-image.jpg}
\end{lstlisting}
